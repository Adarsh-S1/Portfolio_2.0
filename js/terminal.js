...
╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝`;
  ...
  showHelp(outputElement = this.output) {
    ...
    const mainCommands =
      ...
      " " +
      this.wrapWithColor("Show my projects\n", "#ffffff") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "B.Tech AI & Data Science student passionate about",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "building innovative AI, Robotics, and IoT solutions.",
      "#ffffff"
    )}
${this.wrapWithColor(
      "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
      "   AI/ML, Computer Vision, RAG Pipelines, and LLMs using",
      "#ffffff"
    )}
${this.wrapWithColor("   Python, PyTorch, TensorFlow, and LangChain", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
      "   Blending software with hardware — from welding robot",
      "#ffffff"
    )}
${this.wrapWithColor(
      "   frames to writing computer vision pipelines",
      "#ffffff"
    )}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
      "   Full-stack prototyping, hands-on fabrication,",
      "#ffffff"
    )}
${this.wrapWithColor("   creative problem-solving", "#ffffff")}
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">🚀 Projects</span>

<span style="color: #00ffff;">ACADEMIC RAG PIPELINE | LLM Tool</span>
${this.wrapWithColor(
      "2024 - 2025 | Jyothi Engineering College, Kerala",
      "#ffffff"
    )}
${this.wrapWithColor(
      "AI-powered RAG pipeline for academic content retrieval",
      "#98fb98"
    )}

• ${this.wrapWithColor("MongoDB Vector Search", "#ffa07a")} - ${this.wrapWithColor(
      "Searchable database of college notes, textbooks, and PDFs",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      "n8n Automation",
      ...
      "Automated preprocessing workflow for document ingestion",
      "#ffffff"
    )}
• ${this.wrapWithColor("LLM Integration", "#ffa07a")} - ${this.wrapWithColor(
      "Improved accuracy with retrieval-augmented generation",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, LangChain, MongoDB, n8n, Docker",
      "#87cefa"
    )}

<span style="color: #00ffff;">INTERACTIVE AI SANTA | Robotics & AR</span>
${this.wrapWithColor(
      "2024 | Jyothi Engineering College, Kerala",
      "#ffffff"
    )}

• ${this.wrapWithColor("Robot Fabrication", "#ffa07a")} - ${this.wrapWithColor(
      "Human-sized robot using welding, lathe, and metal cutting",
      "#ffffff"
    )}
• ${this.wrapWithColor("Computer Vision", "#ffa07a")} - ${this.wrapWithColor(
      "Real-time facial detection with automated Santa overlays",
      "#ffffff"
    )}
• ${this.wrapWithColor("Servo Control", "#ffa07a")} - ${this.wrapWithColor(
      "Automated movements for the Buon Natale festival",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, OpenCV, Raspberry Pi, Servo Motors, Metal Fabrication",
      "#87cefa"
    )}

<span style="color: #00ffff;">HEARING AID | IoT Device</span>
${this.wrapWithColor(
      "2024 | Thrissur, Kerala",
      "#ffffff"
    )}
...
• ${this.wrapWithColor(
      ...
      "Assistive device displaying spoken text on OLED screen",
      "#ffffff"
    )}
• ${this.wrapWithColor("ESP32", "#ffa07a")} - ${this.wrapWithColor(
      "Leaky bucket algorithm for smooth text flow management",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "ESP32, Bluetooth, OLED Display, C++",
      "#87cefa"
    )}

<span style="color: #00ffff;">SMART BUDDY | IoT Device</span>
${this.wrapWithColor(
      "2024 - 2025 | Thrissur, Kerala",
      "#ffffff"
    )}

• ${this.wrapWithColor("Human Following", "#ffa07a")} - ${this.wrapWithColor(
      "Interactive toy car using computer vision",
      "#ffffff"
    )}
• ${this.wrapWithColor("Voice Conversations", "#ffa07a")} - ${this.wrapWithColor(
      "Gemini API integration for natural dialogue",
      "#ffffff"
    )}
• ${this.wrapWithColor("Obstacle Avoidance", "#ffa07a")} - ${this.wrapWithColor(
      "Raspberry Pi 5 with L298N motor driver",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, Raspberry Pi 5, Gemini API, OpenCV, L298N",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("📜 Certifications:", "#ff8c00")}
• ${this.wrapWithColor("Introduction to Machine Learning — NPTEL (IIT Kharagpur)", "#ffffff")}
• ${this.wrapWithColor("Flutter Development Certification", "#ffffff")}
• ${this.wrapWithColor("Ethical Hacking — NPTEL", "#ffffff")}
...
<span style="color: #00ffff;">Programming Languages:</span>
• ${this.wrapWithColor("Python (PyTorch, TensorFlow, LangChain)", "#ffffff")}
...
• ${this.wrapWithColor("Flask", "#ffffff")}

<span style="color: #00ffff;">Backend & Databases:</span>
• ${this.wrapWithColor("MongoDB (Vector Search)", "#ffffff")}
• ${this.wrapWithColor("Firebase", "#ffffff")}
• ${this.wrapWithColor("MySQL", "#ffffff")}

<span style="color: #00ffff;">Tools & Version Control:</span>
...
• ${this.wrapWithColor("Model Context Protocol (MCP)", "#ffffff")}

<span style="color: #00ffff;">Engineering & Fabrication:</span>
• ${this.wrapWithColor("Welding", "#ffffff")}
• ${this.wrapWithColor("Lathe Operation", "#ffffff")}
• ${this.wrapWithColor("Metal Pipe Cutting", "#ffffff")}
• ${this.wrapWithColor("Raspberry Pi 5", "#ffffff")}
• ${this.wrapWithColor("ESP32", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:adarshs112004@gmail.com" style="color: #ffffff; text-decoration: none;">adarshs112004@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://adarshs.in" target="_blank" style="color: #ffffff; text-decoration: none;">adarshs.in</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Adarsh-S1" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Adarsh-S1</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/adarsh-s-326a97311/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/adarsh-s-326a97311</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "adarsh@portfolio: ~/resume";
...
╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝`;
    ...
    role.textContent = "AI & Data Science • Robotics • IoT";
